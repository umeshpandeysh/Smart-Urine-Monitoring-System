...
const PIPELINE = [
  {
    ...
    desc: 'When a user tests at a UroSense station, urine passes over an embedded sensor array. No collection, contact, or action is required.',
    color: '#2563EB',
    bg: '#EFF6FF',
  },
  {
  ...
  },
  {
    ...
    desc: 'A plain-language report is created with each finding explained in user-friendly terms — no medical degree required to understand it.',
    color: '#D97706',
    bg: '#FFFBEB',
  },
  {
